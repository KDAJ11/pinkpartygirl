...
export default function WhatsAppButton() {
  return (
    <motion.a
      href="https://wa.me/2348000000000?text=Hi%20Pinkpartygirl!%20I%27d%20like%20to%20plan%20something%20special%20%F0%9F%8C%B8"
      target="_blank"
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow duration-200 cursor-pointer"
      style={{
